...
test_repl: test_repl.o memory.o read.o print.o eval.o
	$(CC) $(CFLAGS) test_repl.o read.o memory.o eval.o print.o -o test_repl
...
eval.o: eval.c memory.h types.h eval.h
